...
![_The applications navigation bar_](navbar.png)
...
![Figure 1: _"About" page from the "Covid19: The Battle of independence" app._](about.png)
...
![Figure 2: _"The Cases, Deaths and Government Intervention" page showing the side bar and on the left and the figure output on the right_](casesdeaths.png)
...
![Figure 3: _Drop down selection tool._](date.png)
...
![Figure 4: _date range selector_](dropd.png)
...
![Figure 5: _Table presenting the monthly percentage breakdown for the range of measures, restriction and policies enacted across: social distance measures, movement restrictions and public healthy policy._](table.png)
...
![_Figure 6: Mobility analysis landing page_](mobilitypage.png)
...
![_Figure 7: Displays the figure that visualises the mobility analysis for the chosen city when it is clicked on by the user from the map shown in Figure 6_](mobilityfig.png)
