...
```{r measures-figure, out.height = "150%", out.width = "150%, fig.cap = "Range of measures introduced by the Irish government"}
...
```{r cases-deaths-plot, out.height = "150%", out.width = "150%, fig.cap = "Figure displaying the daily counts for cases and deaths in Ireland"}
